# Generated by Django 3.1.14 on 2023-03-03 08:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good', models.ManyToManyField(blank=True, related_name='good', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download', models.ManyToManyField(blank=True, related_name='download', to='api.Post')),
